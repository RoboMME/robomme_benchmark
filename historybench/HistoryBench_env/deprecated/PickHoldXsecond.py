...
@register_env("PickHoldXsecond", max_episode_steps=2000)
class PickHoldXsecondEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        try:
            red_cube = spawn_random_cube(
                ...
                seed=self.HistoryBench_seed + 10
            )
        ...
        for i in range(10):
            try:
                gray_cube = spawn_random_cube(
                    ...
                    seed=self.HistoryBench_seed + 20 + i
                )
    ...
    def evaluate(self,solve_complete_eval=False):
        ...
        tasks.append({
            ...
            "failure_func": lambda: timelimit(
            self,
            lambda: is_obj_dropped(self, obj=self.target_cube),
            limit_steps=300,
        ),
