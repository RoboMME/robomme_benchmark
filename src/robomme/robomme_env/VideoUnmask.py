...
class VideoUnmask(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        # 让 self.bin_0/_1 天然对应 pickup 目标，task_list 一行不改
        ...
        # color_names[k] = self.bin_k 上 cube 的颜色（前 3 个 bin 都是 colored）
        ...
        # --- 5. selected_bins / selected_bin_indices 统一接口（长度 3，与 Swap
