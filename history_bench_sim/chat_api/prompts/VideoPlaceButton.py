...
3. The targets are all purple disks.
"""
...
VideoPlaceButton_SYSTEM_PROMPT = SYSTEM_PROMPT_with_DEMO.format(
    subgoals=subgoals,
...
VideoPlaceButton_SYSTEM_PROMPT_GROUNDED = SYSTEM_PROMPT_with_DEMO.format(
...
VideoPlaceButton_SYSTEM_PROMPT_ORACLE_PLANNER = SYSTEM_PROMPT_ORACLE_PLANNER.format(
