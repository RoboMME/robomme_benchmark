    ...
    for env_id in env_ids:
        ...
        if num_workers > 1:
            ...
            if len(episode_chunks) <= 1:
                ...
                # 2. Parallel execution - Use two independent Executors to manage tasks for GPU 0 and GPU 1 respectively
                # Assign chunks to GPU 0 and GPU 1
                ...
                # Ensure each GPU has at least 1 worker (if there are tasks)
