...
def main():
    ...
    human_decision = True  # If True, use human inputs
        ...
        with h5py.File(dataset_path, "r") as dataset:
            ...
            for episode in range(num_episodes):
                ...
                try:
                    while True:
                        # =========================================================
                        #  STEP A: Initial Render (Static Plot)
                        # =========================================================
                        ...
                        gui_state, img_a = _prompt_next_task_gui(
                            ...
                            simulated_inputs=[] # Empty action
                        )

                        # Static Plot A (Matplotlib)
                        fig_a = _display_step_image("Step A: Initial State", img_a)
                        figures_to_close.append(fig_a)

                        # =========================================================
                        #  STEP B: Collect Input (Option -> Coords -> Confirm)
                        # =========================================================
                        ...
                        # 3. Confirmation
                        #cmd3 = input("  Command 3 (Confirm, e.g. '1'): ")
                        automation_cmds.append(cmd1)
                        ...
                        if selection_idx is not None:
                            ...
                            elif _tensor_to_bool(evaluation.get("success", False)):
                                print("Result: Success.")
                            else:
                                print("Result: Incomplete/Unknown.")
                        else:
                        ...
                        # Destroy figures created in this iteration before continuing.
