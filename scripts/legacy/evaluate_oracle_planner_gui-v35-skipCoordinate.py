...
def run_input_step_b(solve_options, seg_vis, mouse_select=True):
    """
...
def run_solve_and_evaluate(env, solve_options, selected_target, env_id, seg_vis, seg_raw, base_frames, wrist_frames, automation_cmds):
    """
    ...
    for env_id in env_id_list:
        ...
        with h5py.File(dataset_path, "r") as dataset:
            ...
            for episode in range(num_episodes):
                ...
                try:
                    while True:
                        # [Step A] Visual Prep - Returning individual components
                        ...
                        # [Step B] Input Collection - Passing seg_vis directly
                        automation_cmds, fig_b = run_input_step_b(
                            solve_options,
                            seg_vis,   # Explicit pass
                        ...
                        # [Step C] Process Logic & Solve - Passing components explicitly
