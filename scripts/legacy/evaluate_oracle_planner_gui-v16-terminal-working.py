...
def _prompt_next_task_gui(
    ...
    """
    Renders the UI and processes a batch of inputs based on a persistent state.
    """
    ...
    if external_state is not None:
        ...
        # Update raw segmentation data reference in case it changed
    ...
    def render_current_state(simulated_step_idx, last_cmd):
        ...
        cv2.waitKey(20)  # Short wait to update window
