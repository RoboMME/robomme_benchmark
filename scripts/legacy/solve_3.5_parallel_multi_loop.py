...
def run_env_dataset(
    ...
    Args:
        ...
        difficulty: Optional difficulty hint that overrides the seed-based assignment.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help="Force a difficulty level for every episode (overrides seed-based default).",
    )
    parser.add_argument(
        "--dataset-dir",
        type=Path,
