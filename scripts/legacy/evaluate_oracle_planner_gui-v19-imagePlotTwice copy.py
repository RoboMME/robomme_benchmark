...
def _prompt_next_task_gui(
    ...
    """
    Updates state based on simulated_inputs and returns the annotated image (seg_vis_annotated)
    and the updated state. DOES NOT use cv2.imshow/waitKey.
    """
    ...
    if external_state is not None:
        ...
        state = {
            ...
            "selection": None,
            "seg_raw": seg_raw,
            "seg_rect": None, # Will be set below
            "pending_option": None,
        }
    
    # Initialize logic rect based on input image dimensions
    ...
    # --- 4. Render Final Annotated Image (No GUI) ---
    ...
    # Draw indicators on the numpy array using cv2 drawing primitives (not GUI)
    ...
    for env_id in env_id_list:
        ...
        with h5py.File(dataset_path, "r") as dataset:
            ...
            for episode in range(num_episodes):
                ...
                # =========================================================
                #  MODIFIED SECTION: Static Plotting via Matplotlib
                # =========================================================
                ...
                # 2. STEP A: Initial Render (No Input)
                print("\n[Step A] Initial Render (No Input)")
                ...
                # 3. STEP B: Collect Input & Execute
                _print_terminal_options(solve_options, gui_state)
                
                automation_cmds = []
                print("\n[Input] Please enter 3 commands sequentially (e.g., '1', '150 150', '1'):")
                for k in range(3):
                    user_in = input(f"  Command {k+1}: ")
                    automation_cmds.append(user_in)

                print(f"\n[Step B] Executing Collected Commands: {automation_cmds}")
                ...
                if selection_idx is not None:
                    ...
                    print("\n[Step C] Error: No selection was confirmed by the automation sequence.")
