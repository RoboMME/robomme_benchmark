...
import permanance_inspect as permanance_inspect_module  # scripts/dev3/env_specific_extraction/permanance_inspect.py
...
def main() -> None:
    ...
    # Pipeline 3: Permanence 套件专用 — 由 permanance_inspect 模块负责渲染
